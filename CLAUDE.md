...
| **Contenido de Track 1** | 🚧 **4 de 10 reescritas** con la plantilla ([PLANTILLA_LECCION.md](docs/PLANTILLA_LECCION.md)): Bucles, Funciones, Comprensiones y POO. Con POO se cerraron los 13 huecos de `HUECOS_CONOCIDOS`, que queda vacío. Siguiente: "Listas, Tuplas y Diccionarios" (148 chars, la peor, y POO ya se apoya en ella). El Bloque 4 queda fusionado aquí: los ejercicios se escriben con su lección, no aparte |
