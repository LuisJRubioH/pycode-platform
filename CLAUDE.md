...
**Contenido en números**: 40 lecciones (Track 1: 10 · Track 2: 11 · Track 3: 11 · Track 4: 5 · Track 5: 3) · 150 ejercicios (todos con hidden_tests; Track 1 reescrito entero: 60) · 100 puzzles ELO curados · 70 retos (20 problemas × 3 niveles + 10 curados, todos con hidden_tests y solución de referencia) · 4 capstones · 3 datasets. Migraciones 0001-0015 (Tracks 3-5 y el proxy LLM **no** añaden migraciones; la 0015 es `coding_challenges.hidden_tests`). 205 tests backend. Esquema de datos: `docs/DATABASE.md`. **Nota**: el contenido real vive en `lesson_seed.py`; `lesson_content.py` es código **muerto/duplicado** (no se importa) — no editarlo pensando que seedea.
