...
| **Contenido de Track 1** | 🚧 **5 de 10 reescritas** con la plantilla ([PLANTILLA_LECCION.md](docs/PLANTILLA_LECCION.md)): Bucles, Funciones, Comprensiones, POO y Listas/Tuplas/Diccionarios. `HUECOS_CONOCIDOS` quedó vacío con POO y el test es ya un guard rail puro. Siguiente: "Python desde Cero", "Variables y Tipos" y "Condicionales y Logica" (las tres primeras del temario, todavía en 175-352 chars). El Bloque 4 queda fusionado aquí: los ejercicios se escriben con su lección, no aparte |
